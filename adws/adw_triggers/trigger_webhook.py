...
async def github_webhook(request: Request):
    ...
    try:
        ...
        if workflow:
            ...
            # IMPORTANT: Must specify stdout/stderr and encoding to prevent Unicode errors
            # when subprocess outputs emoji/Unicode characters
            process = subprocess.Popen(
                ...
                stdout=subprocess.DEVNULL,  # Discard stdout (subprocess logs to file)
                stderr=subprocess.DEVNULL,  # Discard stderr (subprocess logs to file)
