...
def get_github_env() -> Optional[dict]:
    ...
    Returns the safe subprocess environment with full parent environment preserved.
    This ensures gh CLI has access to PATH, locale settings, and all system variables.

    Returns:
        Dictionary with full environment, or None to use default inheritance
    """
    # Import here to avoid circular imports
    from .utils import get_safe_subprocess_env

    # Always return the safe environment which preserves parent env
    # This includes PATH, locale, and all necessary system variables
